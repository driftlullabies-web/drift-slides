...
## Card
hook: Day 49 of collecting ideas for your baby's lullaby.
reframe: A little detail to include:
idea: The way they look for you before they let themselves fall asleep.
ask (on-card CTA): Save this for when you're ready to write your lullaby

Rebuild with:
    python3 "Automation Engine/_render_collecting_ideas.py" --day 49 --out "Automation Engine/queue/Collecting Ideas - Day 49"
