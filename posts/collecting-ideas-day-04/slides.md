...
## Card
hook: Day 4 of collecting ideas for your baby's lullaby.
reframe: A moment to remember:
idea: The first time they smiled when they saw you.
ask (on-card CTA): Save this for when you're ready to write your lullaby

Rebuild with:
    python3 "Automation Engine/_render_collecting_ideas.py" --day 4 --out "Automation Engine/queue/Collecting Ideas - Day 04"
