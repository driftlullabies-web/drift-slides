...
## Card
hook: Day 43 of collecting ideas for your baby's lullaby.
reframe: A little detail to include:
idea: The way they fall asleep before you've finished the last verse.
ask (on-card CTA): Save this for when you're ready to write your lullaby

Rebuild with:
    python3 "Automation Engine/_render_collecting_ideas.py" --day 43 --out "Automation Engine/queue/Collecting Ideas - Day 43"
