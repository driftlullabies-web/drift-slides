...
## Card
hook: Day 37 of collecting ideas for your baby's lullaby.
reframe: A moment worth remembering:
idea: The first time you brought your own little personality into the room.
ask (on-card CTA): Save this for when you're ready to write your lullaby

Rebuild with:
    python3 "Automation Engine/_render_collecting_ideas.py" --day 37 --out "Automation Engine/queue/Collecting Ideas - Day 37"
