...
## Card
hook: Day 2 of collecting ideas for your baby's lullaby.
reframe: A little detail to include:
idea: The way their hand finds yours when they're sleepy.
ask (on-card CTA): Save this for when you're ready to write your lullaby

Rebuild with:
    python3 "Automation Engine/_render_collecting_ideas.py" --day 2 --out "Automation Engine/queue/Collecting Ideas - Day 02"
