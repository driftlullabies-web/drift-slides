...
## Card
hook: Day 45 of collecting ideas for your baby's lullaby.
reframe: A memory to put into a verse:
idea: The first night the whole family gathered around your crib.
ask (on-card CTA): Save this for when you're ready to write your lullaby

Rebuild with:
    python3 "Automation Engine/_render_collecting_ideas.py" --day 45 --out "Automation Engine/queue/Collecting Ideas - Day 45"
