...
## Card
hook: Day 31 of collecting ideas for your baby's lullaby.
reframe: A memory to put into a verse:
idea: The first morning you woke up and the whole room felt different.
ask (on-card CTA): Save this for when you're ready to write your lullaby

Rebuild with:
    python3 "Automation Engine/_render_collecting_ideas.py" --day 31 --out "Automation Engine/queue/Collecting Ideas - Day 31"
