...
## Card
hook: Day 11 of collecting ideas for your baby's lullaby.
reframe: (none)
idea: Your sleepy voice might be my favorite sound in the world.
ask (on-card CTA): Steal this line for your baby's lullaby

Rebuild with:
    python3 "Automation Engine/_render_collecting_ideas.py" --day 11 --out "Automation Engine/queue/Collecting Ideas - Day 11"
