...
## Card
hook: Day 3 of collecting ideas for your baby's lullaby.
reframe: A name to include:
idea: The nickname that somehow became their real name.
ask (on-card CTA): Save this for when you're ready to write your lullaby

Rebuild with:
    python3 "Automation Engine/_render_collecting_ideas.py" --day 3 --out "Automation Engine/queue/Collecting Ideas - Day 03"
